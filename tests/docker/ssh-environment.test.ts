      ...
      execFileSync(
        ...
        ['-c', 'source "$1"; persist_ssh_environment "$2"', 'bash', helperPath, environmentPath],
        {
          env: {
            ...
            ANYFUSION_DATA_HOME: '/test/data/anyfusion',
            ANYFUSION_CONFIG_HOME: '/test/data/anyfusion/config',
            METACLAW_HOME: '/test/data/anyfusion/runtime',
            ...
            METACLAW_EXECUTOR_PI_HOME: '/test/pi-home',
            METACLAW_PLANNER_SESSION_DIR: '/test/data/anyfusion/runtime/planner-sessions',
