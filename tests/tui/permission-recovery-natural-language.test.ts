...
describe('App permission recovery natural-language control', () => {
  it('unblocks and resumes a permission-blocked task from authorization confirmation input', async () => {
    ...
    for (const char of '已经授权了，继续刚才那个任务') {
